...
class MultiGoalGridState(AbstractState):
    ...
    def get_neighbors(self):
        ...
        for loc in neighboring_locs:
            ...
            nbr_state = MultiGoalGridState(loc, new_goals, self.dist_from_start + 1, self.use_heuristic, self.maze_neighbors, self.mst_cache)
...
class MultiAgentGridState(AbstractState):
    ...
    def __eq__(self, other):
        return self.state == other.state and isinstance(other, MultiAgentGridState)
